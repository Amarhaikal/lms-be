                ...
                script {
                    ...
                    sh """
                        ...
                        docker run --rm \
                            ...
                            bash -c "dotnet restore && dotnet tool install --global dotnet-ef && export PATH=\"\$PATH:/root/.dotnet/tools\" && dotnet ef migrations script --idempotent --no-connect -o migration.sql"
